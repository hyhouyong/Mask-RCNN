...
input_file = "C:\\Users\\Administrator\\Desktop\\Mask\\train_data\\labelme_json\\"  #文件路径
out_file = "C:\\Users\\Administrator\\Desktop\\Mask\\train_data\\cv2_mask\\"
img_type = ".png"
...
for root, dirs, files in os.walk(input_file,topdown=True):
    for name in natsort.natsorted(dirs):  #natsort,自然排序
        ...
        cv2.imwrite(os.path.join(out_file ,name2 + img_type),img)
