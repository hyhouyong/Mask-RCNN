...
class DrugDataset(utils.Dataset):
    ...
    def load_shapes(self, count, height, width, img_floder, mash_floder, imglist, dataset_root_path):
        # 修改为自己的类别
        self.add_class("shapes", 1, "dianbanshou")
        ...
        for i in range(count):
            ...
            mask_path = dataset_root_path + "labelme_json\\" + filestr + "\\label.png"
    ...
    def load_mask(self, image_id):
        ...
        for i in range(len(labels)):
            if labels[i].find("dianbanshou") != -1:
                labels_from.append("dianbanshou")
